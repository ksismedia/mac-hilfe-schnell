...
const AccordionExecutiveSummary: React.FC<AccordionExecutiveSummaryProps> = ({
  ...
  const categories = [
    ...
    },
    {
      ...
      icon: Users,
      metrics: [
        { name: 'Mitarbeiterqualifikation', score: 0, weight: 0, subtitle: 'Keine Daten eingegeben' },
        { name: 'Arbeitsplatz- und Arbeitgeber-Bewertung', score: 0, weight: 0, subtitle: 'Keine Daten verfügbar' }
      ]
    },
    {
    ...
    },
    {
      ...
      icon: HeartHandshake,
      metrics: [
        ...(staffQualificationScore !== null ? [{ name: 'Personal', score: staffQualificationScore, weight: 8, subtitle: 'Mitarbeiterqualifikation' }] : [{ name: 'Reaktionszeit auf Anfragen', score: 0, weight: 0, subtitle: 'Keine Daten eingegeben' }]),
