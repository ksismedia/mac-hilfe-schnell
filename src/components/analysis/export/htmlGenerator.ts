...
<body>
  <div class="container">
    ...
    <h2 class="category-heading">Online-Qualität · Relevanz · Autorität</h2>
    ...
    <h2 class="category-heading">Webseiten-Performance & Technik</h2>
    ...
    <h2 class="category-heading">Online-/Web-/Social-Media Performance</h2>
    ...
    <h2 class="category-heading">Qualität · Service · Kundenorientierung</h2>
    ...
    <h2 class="category-heading">Markt & Marktumfeld</h2>
    ...
    <h2 class="category-heading">Außendarstellung & Erscheinungsbild</h2>
