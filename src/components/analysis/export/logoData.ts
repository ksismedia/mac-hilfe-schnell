...
export const getLogoHTML = () => {
  ...
  const logoHTML = `
    <div style="text-align: center; margin-bottom: 30px;">
      <div style="width: 145px; height: 140px; padding: 20px 3px 20px 42px; background: #1a1a1a; border-radius: 8px; border: 3px solid #f4c430; display: inline-flex; flex-direction: column; justify-content: center; align-items: flex-end;">
