...
import { ManualCompetitor, ManualSocialData, CompanyServices, CompetitorServices, ManualCorporateIdentityData, ManualContentData, ManualAccessibilityData, ManualBacklinkData, ManualDataPrivacyData, ManualLocalSEOData, ManualIndustryReviewData, ManualOnlinePresenceData, ManualConversionData, ManualMobileData, ManualReputationData, ManualSEOData, useManualData } from '@/hooks/useManualData';
...
interface CustomerHTMLExportProps {
  ...
  showRegionalTrends?: boolean; // Regionale Produkttrends anzeigen
  regionalTrendsData?: any; // Regionale Produkttrends Daten
}
...
const CustomerHTMLExport: React.FC<CustomerHTMLExportProps> = ({ 
  ...
  const {
    ...
    manualSEOData: currentManualSEOData,
    manualDataPrivacyData: currentManualDataPrivacyData,
    manualBacklinkData: currentManualBacklinkData,
    manualContentData: currentManualContentData
  } = useManualData();
  ...
  const exportAsCustomerReport = async () => {
    ...
    const htmlContent = generateCustomerHTML({
      ...
      // WICHTIG: Props haben Priorität vor lokalem Hook-State (lokaler Hook ist immer leer!)
      manualSocialData: manualSocialData || currentManualSocialData,
      manualWorkplaceData: manualWorkplaceData || currentManualWorkplaceData,
      manualCorporateIdentityData: manualCorporateIdentityData || currentManualCorporateIdentityData,
      manualKeywordData,
      keywordScore,
      manualImprintData,
      staffQualificationData,
      quoteResponseData,
      manualContentData: manualContentData || currentManualContentData,
      manualAccessibilityData: manualAccessibilityData || currentManualAccessibilityData,
      manualBacklinkData: manualBacklinkData || currentManualBacklinkData,
      manualDataPrivacyData: manualDataPrivacyData || currentManualDataPrivacyData,
      manualLocalSEOData: manualLocalSEOData || currentManualLocalSEOData,
      manualIndustryReviewData: manualIndustryReviewData || currentManualIndustryReviewData,
      manualOnlinePresenceData: manualOnlinePresenceData || currentManualOnlinePresenceData,
      manualConversionData: manualConversionData || currentManualConversionData,
      manualMobileData: manualMobileData,
      manualReputationData: manualReputationData,
      manualSEOData: manualSEOData || currentManualSEOData,
      privacyData,
      accessibilityData,
