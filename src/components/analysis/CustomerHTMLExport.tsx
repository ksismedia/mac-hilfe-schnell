...
<body>
    <div class="logo-container">
        <div class="logo-box">
            <div style="width: 40px; height: 40px; margin-bottom: 5px; margin-right: -10px;">
